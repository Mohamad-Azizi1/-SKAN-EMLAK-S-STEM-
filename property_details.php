				...
				<div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="d-flex flex-wrap mt-10">
                            ...
                            <div class="address mt-15"><i class="bi bi-geo-alt"></i> 3891 Ranchview Dr. Richardson, California</div>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="position-relative z-1 overflow-hidden border-20">
                                <div class="img-fancy-btn border-10 fw-500 fs-16 color-dark">
                                    Sell all 37 Photos
                                    <a href="images/listing/img_large_01.jpg" class="d-block" data-fancybox="mainImg" data-caption="Duplex orkit villa."></a>
                                ...
                                <div class="theme-sidebar-one d-none d-xl-block">
                                    <div class="agent-info bg-white border-20 p-30">
                                        <img src="images/lazy.svg" data-src="images/agent/img_06.jpg" alt="" class="lazy-img rounded-circle ms-auto me-auto avatar">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="images/listing/img_52.jpg" alt="" class="border-20 w-100">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="images/listing/img_53.jpg" alt="" class="border-20 w-100">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="images/listing/img_54.jpg" alt="" class="border-20 w-100">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="images/listing/img_55.jpg" alt="" class="border-20 w-100">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="images/listing/img_56.jpg" alt="" class="border-20 w-100">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="position-relative mt-25 xs-mt-10">
                                <div class="carousel-indicators d-flex justify-content-between justify-content-xl-start position-relative w-100 h-100">
                                    ...
                                    <button type="button" data-bs-target="#media_slider" data-bs-slide-to="4" aria-label="Slide 5">
                                        <img src="images/listing/img_56_s.jpg" alt="" class="border-10 w-100">
                                    </button>
                                </div>
                                        ...
                                        <div class="accordion-item">
                                            <h2 class="accordion-header">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOneA" aria-expanded="false" aria-controls="collapseOneA">
                                                    <div class="d-flex justify-content-between w-100">
                                                        ...
                                                        <ul class="style-none d-flex flex-wrap align-items-center justify-content-between">
                                                            <li>
                                                                <img src="images/lazy.svg" data-src="images/icon/icon_56.svg" alt="" class="lazy-img icon">
                                                            ...
                                                            <li>
                                                                <img src="images/lazy.svg" data-src="images/icon/icon_57.svg" alt="" class="lazy-img icon">
                                            ...
                                            <div id="collapseOneA" class="accordion-collapse collapse show" data-bs-parent="#accordionTwo">
                                                <div class="accordion-body">
                                                    <img src="images/listing/floor_3.jpg" alt="" class="w-100 border-10">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="accordion-item">
